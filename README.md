...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/lalburst-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/lalburst-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add lalburst liblalburst python-lalburst
# for installing globally
pixi global install lalburst liblalburst python-lalburst
```
...
It is possible to list all of the versions of `lalburst` available on your platform:
...
```
pixi search lalburst --channel conda-forge
```
